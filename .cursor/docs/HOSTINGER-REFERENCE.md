...
| `DIGITALSTUDIOZ_DOMAIN` | Live domain for this project |
| `DIGITALSTUDIOZ_WEB_ROOT` | Remote public web root |
| `DIGITALSTUDIOZ_APP_ROOT` | Node.js app root (if applicable) |
