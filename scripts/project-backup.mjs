// project-backup.mjs — DigitalStudioz
// Backups go to: G:\Hermes_Project_BackUpz\DigitalStudioz\
//
// Usage:
...
const REPO_ROOT = "D:\\Hermes\\projects\\DigitalStudioz";
const DEFAULT_BACKUP_ROOT = "G:\\Hermes_Project_BackUpz\\DigitalStudioz";
const BACKUP_FOLDER_BASE = "digitalstudioz" + "-project";
...
const NOTES_FOOTER = "\n*Backup created — DigitalStudioz project.*\n";
